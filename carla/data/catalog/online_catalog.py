...
class OnlineCatalog(DataCatalog):
    # The OnlineCatalog is a subclass of DataCatalog and it is designed to provide access to datasets loaded from an online repository for specific use cases.
    # OnlineCatalog inherits from the DataCatalog class. This allows OnlineCatalog to inhereit the properties and methods of DataCatalog.
    """
    ...
    def __init__(
        ...
        encoding_method: str = "OneHot_drop_biary",
    ):
