...
for dataset in datasets:
    ...
    dynamic_num_cols[dataset] = ['CRP', 'LacticAcid', 'Leucocytes', "hour", "weekday", "month", "timesincemidnight",
...
dynamic_num_cols[dataset] = ["Qty_Completed", "Qty_for_MRB", "activity_duration", "hour", "weekday", "month",
...
for dataset, fname in bpic2017_dict.items():
    ...
    dynamic_num_cols[dataset] = ['FirstWithdrawalAmount', 'MonthlyCost', 'NumberOfTerms', 'OfferedAmount',
...
for i in range(1, 7):
    for suffix in ["", "_sample10000", "_sample30000"]:
        ...
        # features for classifier
        dynamic_cat_cols[dataset] = ["Activity", 'Resource', 'actOrange', 'actRed', 'blocked', 'caseType', 'diagnosis',
...
for formula in range(1, 5):
    ...
    static_cat_cols[dataset] = ["Diagnosis", "Treatment code", "Diagnosis code", "Specialism code",
                                "Diagnosis Treatment Combination ID"]
    dynamic_num_cols[dataset] = ["Number of executions", "hour", "weekday", "month", "timesincemidnight",
                                 "timesincelastevent", "timesincecasestart", "event_nr", "open_cases"]
    static_num_cols[dataset] = ["Age"]
